...
import { FaArrowLeft, FaPlay, FaStop, FaDownload, FaTable, FaDatabase } from 'react-icons/fa';
...
export default function ExtractionDetailPage() {
  ...
  const handleViewDataGrid = () => {
    router.push(`/data-grid/${params.id}`);
  };
          ...
          <div className="d-flex justify-content-between align-items-start">
            ...
            <div className="d-flex gap-2">
              ...
              {job.status === 'completed' && (
                <Button variant="primary" onClick={handleViewDataGrid}>
      ...
      <Row className="mb-4">
        <Col md={6}>
          <Card className="shadow-sm border-0 h-100">
            ...
            <Card.Body>
              <div className="mb-2">
                <strong>Connection:</strong> {job.connection_name}
              </div>
              <div className="mb-2">
                <strong>Table:</strong> {job.table_name || 'Custom Query'}
              </div>
              {job.schema_name && (
                <div className="mb-2">
                  <strong>Schema:</strong> {job.schema_name}
                </div>
              )}
              {job.columns && job.columns.length > 0 && (
                <div className="mb-2">
                  ...
                  {job.columns.map(col => (
                    <Badge key={col} bg="secondary" className="me-1">
                      {col}
                    </Badge>
                  ))}
                </div>
        ...
        <Col md={6}>
          <Card className="shadow-sm border-0 h-100">
            ...
            <Card.Body>
              <div className="mb-2">
                <strong>Batch Size:</strong> {job.batch_size} rows
              </div>
              <div className="mb-2">
